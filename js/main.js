...
$(document).ready(function(){
   ...
   $('.moon').click(function(){
       ...
       $('.sun').show();
        ...
        $('.skills .accordion .accordion-button:not(.collapsed),.skills .accordion-body,.skills .accordion .accordion-item,.accordion-header,.accordion').css({background: '#000'});
...
$(document).ready(function(){
    $('.sun').click(function(){
        ...
        $('.header .main-text p,.header .main-text span,.header .scroll-down span').css({color: 'rgba(26, 25, 25, 0.685)'});
        ...
        $('.skills .accordion .accordion-button:not(.collapsed),.skills .accordion-body,.accordion-item,.accordion-header,.accordion').css({background:'#fff'});
